              ...
              <div key={accommodation.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <div className="flex space-x-3">
                    <Link
                      href={`/booking?accommodation=${accommodation.id}`}
                    ...
                    <button className="px-4 py-3 border border-blue-600 text-blue-600 hover:bg-blue-50 rounded-lg font-medium transition-colors duration-300">
                      Detail
                    </button>
                  </div>
                </div>
